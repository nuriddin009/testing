...
public class PokemonServiceTest {
    ...
    public void PokemonService_CreatePokemon_ReturnsPokemonDto() {
        ...
        PokemonDto pokemon1 = pokemonService.createPokemon(pokemonDto);
    ...
    public void PokemonService_GetPokemonById_ReturnsPokemonDto() {
        ...
        PokemonDto pokemon1 = pokemonService.getPokemonById(1);
        Assertions.assertThat(pokemon1).isNotNull();
    }
    ...
    public void PokemonService_UpdatePokemon_ReturnsPokemonDto() {
        ...
        PokemonDto pokemonDto = PokemonDto.builder().name("pickachu")
                .type("electric")
                .build();
